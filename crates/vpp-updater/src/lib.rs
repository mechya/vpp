...
//! # Status
//!
//! Not ported yet. The C++ reference implementation is `updater/src/http.cpp`, `updater/src/updater.cpp`, and the publisher-trust section of `viewer/src/main.cpp`. The planned Rust files are listed in `docs/rust-port.md` §5.3.
