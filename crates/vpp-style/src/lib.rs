...
//! # Status
//!
//! Not ported yet. The C++ reference implementation is `runtime/src/css.cpp`, `runtime/src/style.cpp`, and the `style.bin` half of `runtime/src/binary.cpp`. The planned Rust files are listed in `docs/rust-port.md` §5.3.
