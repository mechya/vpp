...
* **Origin:** the version 3 fixtures are written by the Rust packager from `examples/` when `vpp-format` is ported, checked against `docs/formats/package.md`, and then frozen (`docs/rust-port.md` §6.3).
